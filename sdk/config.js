...
module.exports = {
  SDK_VERSION: '1.0.0.0',                   // SDK 版本号（用于日志上报和初始化入参）
  ...
  ENV: {
    stable: {
      ...
      mobileQueryUrl: 'https://110.cm253.com:8445/open/web/wxprog-mobile-query', // 手机号查询接口
    },
    release: {
      initUrl: 'https://sy.cl2m.cn/sy/h5/init',                     // 初始化接口
      logUrl: 'https://h5.253.com/web/report',                      // 日志上报接口
      mobileQueryUrl: 'https://api.253.com/open/web/wxprog-mobile-query', // 手机号查询接口
    },
  },
};
